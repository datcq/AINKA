(function () {
	$('#slider').on('ready', '.asset_17', function (e, el) {
		...
		$('.flag4, .flag5',slide).delay(1000).fadeIn(200);
		...
		function checkFrame(){		
			...
			switch($(".globe",slide).spritespin("frame")){
				...
				case 11:
				case 12:
					$('.flag1,.flag2,.flag3,.flag5',slide).show();
					$('.flag4',slide).hide();
					break;
				case 13:
				case 14:
				...
				case 19:
					$('.flag1,.flag2,.flag3',slide).show();
					$('.flag5, .flag4',slide).hide();
					break;
				case 20:
					$('.flag1,.flag2, .flag5,.flag4,.flag3',slide).hide();
					break;	
				case 21:
					$('.flag5,.flag4,.flag3,.flag2',slide).hide();
					break;	
				case 22:
					$('.flag5,.flag4,.flag3,.flag2,.flag1',slide).hide();
					break;
