...
anddev.u=_;
$.Controller("Anddev.Controller", {
	setup : function () {
		_setup.apply(this);
		this._super.apply(this, arguments);
	},
	plugin : Anddev.Class.plugin
}, {
...
Anddev.Controller("Anddev.slideshow", {
	defaults : {
		delay : 500,
		effect : "fade",
		duration : 500,
	...
	change : function(index) {
		...
		this.element.change(this.options.effect, this.options.effectOptions,
				this.options.duration, function() {
					instance.lock = false; // release lock
					instance._trigger("onShow", null, [ instance, current,
							index ]);
				});
		return true;
	},
